...
public class ODataConverter<T> {
	...
	public ODataConverter(Class<T> clazz) {
		...
		// TODO: Currently we are facing issues to @AutoWired ObjectMapper from
		// JacksonConfig class(Global init)
	...
	public String clientEntitySetIteratorToJson(ClientEntitySetIterator<ClientEntitySet, ClientEntity> iterator)
			throws Exception {
